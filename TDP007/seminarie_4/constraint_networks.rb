...
def celsius2fahrenheit
  ...
  const1 = Connector.new('const1')
  const2 = Connector.new('const2')
  const3 = Connector.new('const3')
  out = Connector.new('out')
  out2 = Connector.new('out2')

  const1.user_assign(5)
  const2.user_assign(32)
  const3.user_assign(9)

  Multiplier.new(const3, c, out)
  Multiplier.new(const1, out2, out)
  Adder.new(out2, const2, f)
...
# D, [2007-02-08T09:15:19.503031 #521] DEBUvalueG -- : 32 ignored request
